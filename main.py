from tokenize_and_stuff import get_tokens_and_labels, split_into_sents, get_unique_labels, get_model_inputs, calculate_class_weights
...
def main():
    ...
    epochs = 50 #number of epochs, how many times do we iterate over the dataset?
